...
namespace Sprint0Sandbox
{
    public class Startup
    {
        ...
        {
            services.AddDbContext<OdsdbContext>(options => options.UseSqlServer(@"Data Source=devods.nrch.us;Initial Catalog=odsdb;Integrated Security=SSPI;"));


            var signingKey = new X509SecurityKey(new System.Security.Cryptography.X509Certificates.X509Certificate2("C:/Users/mkoh/Desktop/foo.cer"));
            services.AddAuthentication(options => {
                //options.DefaultAuthenticateScheme = JwtBearerDefaults.AuthenticationScheme;// "CustomJwt";
            ...
            {
                options.Wtrealm = "https://localhost:44306";                                    // Which app am I trying to access? Must match identifier of relying party trust in ADFS
                options.MetadataAddress = "https://disso.nrcbeta.com/FederationMetadata/2007-06/FederationMetadata.xml";
                //options.ForwardAuthenticate = "CustomJwt";
            })
            //.AddJwtBearer(options => //"CustomJwt", options =>
            //{
            ...
            //        ValidateIssuer = true,
            //        ValidIssuer = "https://disso.nrcbeta.com/adfs/services/trust",
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env)
        {
            ...
            app.UseAuthentication();    // This must come before UseMvc()
